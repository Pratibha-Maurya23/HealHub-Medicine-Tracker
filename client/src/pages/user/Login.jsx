...
export default function UserLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        const loggedUser = await signin(formData.email, formData.password);
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className={`flex-1 py-2 rounded-lg border ${
                      role === "user" ? "bg-teal-600 text-white" : "bg-gray-100"
                    }`}
                  ...
                  <button
                    type="button"
                    className={`flex-1 py-2 rounded-lg border ${
                      role === "pharmacist" ? "bg-teal-600 text-white" : "bg-gray-100"
                    }`}
